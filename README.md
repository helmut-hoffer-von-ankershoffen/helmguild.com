...
| `/rfc/ammp/` and `/de/rfc/ammp/` | AMMP Internet-Draft summary; canonical `.txt` at `/rfc/ammp/draft-ammp-01.txt`; reference implementation at [`ammp-mcp`](https://github.com/helmut-hoffer-von-ankershoffen/ammp-mcp) |
